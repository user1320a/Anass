...
function unlockGate(){const v=(gateInput.value||"").trim();if(v==="2045"){gateError.style.display="none";gateOverlay.style.display="none";startExperience()}else{gateError.style.display="block";gateInput.value="";gateInput.focus()}}
